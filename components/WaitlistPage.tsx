  ...
  if (status === 'success') {
        return (
                <div className="text-center animate-success-pop">
                        ...
                        <div className="text-xl font-bold text-white mb-2">You&apos;re on the list.</div>div>
    ...
    return (
          <div className="min-h-screen bg-brand-bg font-poppins text-brand-text overflow-x-hidden">
            {/* Fixed Nav */}
                <nav className="fixed top-0 left-0 right-0 z-50 bg-[rgba(3,3,3,0.8)] backdrop-blur-xl border-b border-brand-border">
                        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                                  <img src="/taptico-logo-white.png" alt="TAPTICO.AI" className="h-8" />
            ...
            {/* Hero Section */}
                <section className="relative pt-32 pb-24 px-6 overflow-hidden">
                        ...
                        <div className="relative max-w-3xl mx-auto text-center">
                                  ...
                                  <p className="text-2xl md:text-3xl font-semibold mb-6">
                                              Your business <span className="text-brand-lightblue">runs itself.</span>span> You just tell it what to do.
                                  </p>p>
                                  ...
                                  <div className="relative max-w-md mx-auto">
                                              ...
                                              <div className="bg-[rgba(11,11,11,0.7)] backdrop-blur-[20px] border border-brand-border rounded-2xl p-8">
                                                            ...
                                                            <div className="mb-2">
                                                                            <span className="text-lg text-brand-dim line-through mr-3">$2,500/mo</span>span>
                                                                            <span className="text-4xl font-bold text-white">$1,500</span>span>
                                                                            <span className="text-lg text-brand-gray ml-1">/month</span>span>
                                                            </div>div>
                ...
                <div className="max-w-5xl mx-auto px-6"><GradientDivider /></div>div>
          
            {/* How It Works */}
                <section className="py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                                  <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-lightblue text-center mb-4">How It Works</p>p>
                                  <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Three steps. Then you go live your life.</h2>h2>
                                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="text-xs font-bold tracking-[0.2em] uppercase text-brand-dim mb-3">Step One</div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Free discovery call</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Our AI agent Disco Dave interviews you (or fill out a quick form). You get a free custom plan showing exactly what AI can do for your business. No commitment, no pitch.</p>p>
                                              </div>div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="text-xs font-bold tracking-[0.2em] uppercase text-brand-dim mb-3">Step Two</div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">We build it in 24 hours</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Say the word and we handle everything. Onboarding, configuration, training the system on your business, your industry, your competitors. You bring your own API keys. We do the rest.</p>p>
                                              </div>div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="text-xs font-bold tracking-[0.2em] uppercase text-brand-dim mb-3">Step Three</div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Send a voice memo. Done.</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">That&apos;s it. &quot;Run the New Listing Playbook for 112 Main St.&quot; Your playbook fires: social posts go out, listings go live, clients get notified. You go to the recital.</p>p>
                                              </div>div>
                                  </div>div>
                        </div>div>
                </section>section>
            ...
            {/* Playbooks Section */}
                <section className="py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                                  <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-lightblue text-center mb-4">Playbooks, Not Dashboards</p>p>
                                  <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">You say the word. The playbook runs.</h2>h2>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                                            <svg className="w-5 h-5 text-brand-lightblue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" /></svg>svg>
                                                            </div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Sales playbooks</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Prospecting, cold outreach, follow-ups, lead scoring. One command triggers the whole sequence. Personalized to every lead.</p>p>
                                              </div>div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                                            <svg className="w-5 h-5 text-brand-lightblue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg>svg>
                                                            </div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Content playbooks</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Social posts, blogs, newsletters, ad copy. Written in your voice. Scheduled and published. You never open Canva again.</p>p>
                                              </div>div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                                            <svg className="w-5 h-5 text-brand-lightblue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>svg>
                                                            </div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Operations playbooks</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Client onboarding, check-ins, renewals, scheduling. Your clients feel taken care of because they are.</p>p>
                                              </div>div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                                            <svg className="w-5 h-5 text-brand-lightblue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" /></svg>svg>
                                                            </div>div>
                                                            <h3 className="text-lg font-bold text-white mb-3">Intel playbooks</h3>h3>
                                                            <p className="text-sm text-brand-gray leading-relaxed">Morning briefs on your phone. Weekly scorecards. Competitor alerts. Ask a question, get an answer. No login required.</p>p>
                                              </div>div>
                                  </div>div>
                        </div>div>
                </section>section>
            ...
            {/* Quote */}
                <section className="py-24 px-6">
                        <div className="max-w-3xl mx-auto text-center">
                                  ...
                                  <cite className="text-sm font-semibold text-brand-gray not-italic tracking-wide">Nick Tapp, Founder</cite>cite>
                        </div>div>
                </section>section>
            ...
            {/* Proof Bar */}
                <section className="py-20 px-6">
                        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                                  <div><div className="text-4xl font-bold text-white">25+</div>div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Years Experience</div>div></div>div>
                                  <div><div className="text-4xl font-bold text-white">73</div>div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">AI Agents</div>div></div>div>
                                  <div><div className="text-4xl font-bold text-white">91%</div>div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Gross Margins</div>div></div>div>
                                  <div><div className="text-4xl font-bold text-white">4</div>div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Active Clients</div>div></div>div>
                        </div>div>
                </section>section>
                ...
                <section className="py-24 px-6">
                        <div className="max-w-3xl mx-auto text-center">
                                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                                              One employee costs $60K a year. This costs less. And <span className="text-brand-lightblue">never sleeps.</span>span>
                                  </h2>h2>
