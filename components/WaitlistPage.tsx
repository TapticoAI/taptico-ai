    ...
    return (
          <div className="min-h-screen bg-brand-bg font-poppins text-brand-text overflow-x-hidden">
            ...
            {/* Hero Section */}
                ...
                <div className="max-w-5xl mx-auto px-6"><GradientDivider /></div>
          
            {/* How It Works */}
                <section className="py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                                  <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-lightblue text-center mb-4">How It Works</p>
                                  <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Three steps. Then you go live your life.</h2>
                                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Our AI agent Disco Dave interviews you (or fill out a quick form). You get a free custom plan showing exactly what AI can do for your business. No commitment, no pitch.</p>
                                              </div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Say the word and we handle everything. Onboarding, configuration, training the system on your business, your industry, your competitors. You bring your own API keys. We do the rest.</p>
                                              </div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">That&apos;s it. &quot;Run the New Listing Playbook for 112 Main St.&quot; Your playbook fires: social posts go out, listings go live, clients get notified. You go to the recital.</p>
                                              </div>
                                  </div>
                        </div>
                </section>
            ...
            {/* Playbooks Section */}
                <section className="py-24 px-6">
                        <div className="max-w-5xl mx-auto">
                                  <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-lightblue text-center mb-4">Playbooks, Not Dashboards</p>
                                  <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">You say the word. The playbook runs.</h2>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Prospecting, cold outreach, follow-ups, lead scoring. One command triggers the whole sequence. Personalized to every lead.</p>
                                              </div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Social posts, blogs, newsletters, ad copy. Written in your voice. Scheduled and published. You never open Canva again.</p>
                                              </div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Client onboarding, check-ins, renewals, scheduling. Your clients feel taken care of because they are.</p>
                                              </div>
                                              <div className="bg-brand-card border border-brand-border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-borderlight">
                                                            <div className="w-10 h-10 rounded-xl bg-[rgba(21,93,252,0.12)] border border-[rgba(80,162,255,0.2)] flex items-center justify-center mb-5">
                                                            ...
                                                            <p className="text-sm text-brand-gray leading-relaxed">Morning briefs on your phone. Weekly scorecards. Competitor alerts. Ask a question, get an answer. No login required.</p>
                                              </div>
                                  </div>
                        </div>
                </section>
            ...
            {/* Quote */}
                <section className="py-24 px-6">
                        <div className="max-w-3xl mx-auto text-center">
                                  ...
                                  <cite className="text-sm font-semibold text-brand-gray not-italic tracking-wide">Nick Tapp, Founder</cite>
                        </div>
                </section>
            ...
            {/* Proof Bar */}
                <section className="py-20 px-6">
                        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                                  <div><div className="text-4xl font-bold text-white">25+</div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Years Experience</div></div>
                                  <div><div className="text-4xl font-bold text-white">73</div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">AI Agents</div></div>
                                  <div><div className="text-4xl font-bold text-white">91%</div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Gross Margins</div></div>
                                  <div><div className="text-4xl font-bold text-white">4</div><div className="text-xs font-semibold tracking-[0.15em] uppercase text-brand-dim mt-2">Active Clients</div></div>
                        </div>
                </section>
